  ...
  const teamMembers = [
    {
      ...
      bio: 'Leading Shenbury\'s AI-powered authentication protocol with deep expertise in institutional-grade tokenization and multi-agent AI systems. Former Blockchain SME at DTCC, where he contributed to the Forbes Blockchain Award-winning private placement tokenization platform. Served as the first Blockchain SME at Ford Motor Credit Company, collaborating on blockchain solutions for automotive financing ecosystem innovations. Specialized in real-world asset tokenization, privacy-preserving technologies, and regulatory compliance frameworks.',
      highlights: [
        'Contributed to DTCC\'s first distributed ledger technology project (Forbes Blockchain Award Winner 2020)',
        'Collaborated on cross-functional teams to deliver enterprise blockchain solutions with reduced settlement times',
